...
public struct RowModel: Equatable, Codable {
       public let type: String = "row"

       public let children: [RenderedComponentModel]
       public let horizontalArrangement: RenderedHorizontalArrangement?
       public let verticalAlignment: RenderedVerticalAlignment?
       ...
       private enum CodingKeys: String, CodingKey {
           case type, children, horizontalArrangement, verticalAlignment, isScrollable
           case id, hash, interactions, paddings, margins, width, height, backgroundColor, border, shape
       }

       public init(
           children: [RenderedComponentModel],
           horizontalArrangement: RenderedHorizontalArrangement? = nil,
           verticalAlignment: RenderedVerticalAlignment? = nil,
       ...
       public init(from decoder: Decoder) throws {
           ...
           self.horizontalArrangement = try c.decodeIfPresent(RenderedHorizontalArrangement.self, forKey: .horizontalArrangement)
           self.verticalAlignment = try c.decodeIfPresent(RenderedVerticalAlignment.self, forKey: .verticalAlignment)
           self.isScrollable = try c.decodeIfPresent(Bool.self, forKey: .isScrollable)
       ...
       public func encode(to encoder: Encoder) throws {
           ...
           try c.encodeIfPresent(horizontalArrangement, forKey: .horizontalArrangement)
           try c.encodeIfPresent(verticalAlignment, forKey: .verticalAlignment)
           try c.encodeIfPresent(isScrollable, forKey: .isScrollable)
