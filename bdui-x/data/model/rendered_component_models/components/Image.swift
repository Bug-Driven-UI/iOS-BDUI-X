...
public struct ImageModel: Equatable, Codable {
        ...
        public let badge: RenderedBadgeModel?
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.badge = try c.decodeIfPresent(RenderedBadgeModel.self, forKey: .badge)
