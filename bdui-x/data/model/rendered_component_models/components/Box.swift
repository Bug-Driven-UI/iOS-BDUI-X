...
public struct BoxModel: Equatable, Codable {
        public let type: String = "box"

        public let children: [RenderedComponentModel]
        public let contentAlignment: RenderedHorizontalAndVerticalAlignment?
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.contentAlignment = try c.decodeIfPresent(RenderedHorizontalAndVerticalAlignment.self, forKey: .contentAlignment)
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            try c.encodeIfPresent(contentAlignment, forKey: .contentAlignment)
